...
<html>
  ...
  <div class="panel-body">
     <div class="jumbotron text-center" style="">
      ...
      <div class="caption">
          <h3 style="color: black" class="text-center">Crab! This Document has been Deleted!</h3>    
          <p class="text-center">Page will be redirected in <span id ="num">5</span> seconds!</p>
          <p><a class="btn btn-primary btn-lg" role="button" href="show">Back Immediately</a></p>
      </div>
      </div>
      </div> 
      </div>
